...
🎓 **3rd Year Information Systems Student** @ West Visayas State University  
💻 **Full-Stack Developer** | PHP • JavaScript • TypeScript • Rust (Tauri)  
☕ **Specialty Coffee Enthusiast** | Aspiring Barista  
...
A comprehensive project management system developed for the DOST-SETUP initiative.
- **Tech Stack:** Tauri v2, React, TypeScript, Supabase.
- **Role:** Full-Stack Developer focusing on mobile-responsive UI and real-time data integration.
...
- **Features:** Full CRUD operations for inventory tracking and professional documentation.

### 📸 ShotConnect
A real-time booking platform for freelance photographers, bridging the gap in the local gig economy.
- **Focus:** UI/UX Design, business modeling, and pitch development.
...
- **Goal:** To eventually integrate my technical background with the coffee industry to improve café operational efficiency.

---

## 🛠️ Technical Toolkit
- **Languages:** PHP, JavaScript, TypeScript, SQL, Rust.
- **Frameworks/Tools:** React, Vite, Tauri, XAMPP, Git.
- **Design:** UI/UX Design (Figma), HCI Principles, Color Theory.
- **Systems:** Windows/Linux environment troubleshooting, Android Emulation/ADB.
